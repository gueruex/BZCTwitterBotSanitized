  ...
  },
  {
    ...
    with open('zombies.txt', 'w', encoding='utf-8') as f: #Open the stream to write the zombies
      for foo in range(2000): #Loop through all top 2000 zombies
        ...
        r = requests.get('https://opensea.io/assets/matic/0x4bca2c2ece9402b5d4dd031b49d48166c40b7957/'+rankDatabase[foo]["ID"], headers=passHeader) #Sending the get request
